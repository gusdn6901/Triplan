...
//    LatLng latLang2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prev_add_trip);
        alarmClock = findViewById(R.id.editClock);
        alarmDate = findViewById(R.id.editDate);
        ...
        profileDAO = new ProfileDAOImpl(AddSchedule.this);
        SharedPreferencesManager preferencesManager = new SharedPreferencesManager(AddSchedule.this);
        ...
        alarmDateBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(AddSchedule.this, date1, currentCalendar
        ...
        alarmClockBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker2 = new TimePickerDialog(AddSchedule.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (trip_name.matches("") || alarmClock.getText().toString().matches("") || alarmDate.getText().toString().matches("") || long1 == 0.0 || long2 == 0.0 || (!single.isChecked() && !round.isChecked())) {
                    Toast.makeText(AddSchedule.this, "missing fields !", Toast.LENGTH_LONG).show();

                } else if (myCalendar.compareTo(currentCalendar) <= 0) {

                    Toast.makeText(AddSchedule.this, "cannot insert passed time", Toast.LENGTH_SHORT).show();
                } else if (tripNames.contains(name.getText().toString())) {
                    Toast.makeText(AddSchedule.this, "Duplicated trip name !", Toast.LENGTH_LONG).show();

                } else {
                    if (single.isChecked()) {
                        TripDTO t;

                        TripDAOImpl tripDAO = new TripDAOImpl(AddSchedule.this);
                        ...
                        tripDTO.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.UPCOMING);
                        ...
                        Intent alarmIntent = new Intent(AddSchedule.this, AlarmReceiver.class);
                        ...
                        PendingIntent pendingIntent = PendingIntent.getBroadcast(AddSchedule.this, t.getTrip_id(), alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                    ...
                    if (round.isChecked()) {
                        if (myCalendarRound.compareTo(myCalendar) <= 0) {
                            Toast.makeText(AddSchedule.this, "cannot return before going", Toast.LENGTH_SHORT).show();
                        } else {
                            TripDTO t;
                            TripDAOImpl tripDAO = new TripDAOImpl(AddSchedule.this);
                            TripDTO tripDTO = new TripDTO();
                            ...
                            tripDTO2.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.UPCOMING);
                            ...
                            alarmIntent.putExtra("lat1", lat1);
                            alarmIntent.putExtra("lat2", lat2);
                            pendingIntent = PendingIntent.getBroadcast(AddSchedule.this, t.getTrip_id(), alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
                            alarmManager.set(AlarmManager.RTC_WAKEUP
                                    , myCalendar.getTimeInMillis(), pendingIntent);
                            alarmManagerRound = (AlarmManager) getApplicationContext().getSystemService(ALARM_SERVICE);
                            Intent alarmIntentRound = new Intent(AddSchedule.this, AlarmReceiver.class);
                            ...
                            pendingIntentRound = PendingIntent.getBroadcast(AddSchedule.this, tRound.getTrip_id(), alarmIntentRound, PendingIntent.FLAG_UPDATE_CURRENT);
