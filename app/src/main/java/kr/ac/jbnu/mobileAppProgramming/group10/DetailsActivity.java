...
import kr.ac.jbnu.mobileAppProgramming.group10.database.dao.daoimpl.NoteDAOImpl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ex.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.DONE);
        ...
        status.setText(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.UPCOMING);
...
//                            "cannot insert passed time"
                            ...
                            ex.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.UPCOMING);
                            tripDAO.updateTrip(ex);
            ...
            public void onClick(View view) {
                if (ex.getTrip_rounded() == 1) {
                    ...
                    if (tripDTO2.getTrip_id() != null) {
                        ...
                        tripDTO2.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.CANCELLED);
                    ...
                    ex.setTrip_status(kr.ac.jbnu.mobileAppProgramming.group10.database.dto.Status.CANCELLED);
                    tripDAO.updateTrip(ex);
                    alarmManager = (AlarmManager) getApplicationContext().getSystemService(ALARM_SERVICE);
                    Intent myIntent = new Intent(DetailsActivity.this,
                            AlarmReceiver.class);
